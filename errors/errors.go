...
// SingleErrorResponseError is a custom error.
type SingleErrorResponseError struct {
	apiError.ApiError
	MError string `json:"error"`
}

// NewSingleErrorResponseError is a constructor for SingleErrorResponseError.
// It creates and returns a pointer to a new SingleErrorResponseError instance with the given statusCode and body.
func NewSingleErrorResponseError(
	statusCode int,
	body string) *SingleErrorResponseError {
	return &SingleErrorResponseError{
		ApiError: apiError.ApiError{
			StatusCode: statusCode,
			Body:       body,
		},
...
// Error implements the Error method for the error interface.
// It returns a formatted error message for SingleErrorResponseError.
func (s *SingleErrorResponseError) Error() string {
	return fmt.Sprintf("SingleErrorResponseError occured %v", s.Body)
}
