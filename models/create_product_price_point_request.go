...
// String implements the fmt.Stringer interface for CreateProductPricePointRequest,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (c CreateProductPricePointRequest) String() string {
    return fmt.Sprintf(
    	"CreateProductPricePointRequest[PricePoint=%v, AdditionalProperties=%v]",
