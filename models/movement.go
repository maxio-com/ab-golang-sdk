...
func (m *Movement) UnmarshalJSON(input []byte) error {
    ...
    additionalProperties, err := UnmarshalAdditionalProperties(input, "timestamp", "amount_in_cents", "amount_formatted", "description", "category", "breakouts", "line_items", "subscription_id", "subscriber_name")
    if err != nil {
    	return err
    }
