...
func (s *SubscriptionGroupMemberError) UnmarshalJSON(input []byte) error {
    var temp tempSubscriptionGroupMemberError
...
// tempSubscriptionGroupMemberError is a temporary struct used for validating the fields of SubscriptionGroupMemberError.
type tempSubscriptionGroupMemberError  struct {
    Id      *int    `json:"id,omitempty"`
    Type    *string `json:"type,omitempty"`
    Message *string `json:"message,omitempty"`
}
