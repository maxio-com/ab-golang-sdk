...
func (c *CreateSubscription) toMap() map[string]any {
	...
	if c.CustomPrice != nil {
		structMap["custom_price"] = c.CustomPrice
	}
	if c.CouponCode != nil {
	...
	if c.InitialBillingAt != nil {
		structMap["initial_billing_at"] = c.InitialBillingAt
	}
	...
	if c.CustomerAttributes != nil {
		structMap["customer_attributes"] = c.CustomerAttributes
	}
	if c.PaymentProfileAttributes != nil {
		structMap["payment_profile_attributes"] = c.PaymentProfileAttributes
	}
	if c.CreditCardAttributes != nil {
		structMap["credit_card_attributes"] = c.CreditCardAttributes
	}
	if c.BankAccountAttributes != nil {
		structMap["bank_account_attributes"] = c.BankAccountAttributes
	}
	if c.Components != nil {
		structMap["components"] = c.Components
	}
	if c.CalendarBilling != nil {
		structMap["calendar_billing"] = c.CalendarBilling
	}
	if c.Metafields != nil {
	...
	if c.OfferId != nil {
		structMap["offer_id"] = c.OfferId
	}
	if c.PrepaidConfiguration != nil {
		structMap["prepaid_configuration"] = c.PrepaidConfiguration
	}
	...
	if c.AgreementAcceptance != nil {
		structMap["agreement_acceptance"] = c.AgreementAcceptance
	}
	if c.AchAgreement != nil {
		structMap["ach_agreement"] = c.AchAgreement
	}
...
func (c *CreateSubscription) UnmarshalJSON(input []byte) error {
	...
	c.InitialBillingAt = temp.InitialBillingAt
