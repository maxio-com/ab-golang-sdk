...
// voidInvoiceEvent is a temporary struct used for validating the fields of VoidInvoiceEvent.
type voidInvoiceEvent  struct {
    Id        *int64                `json:"id"`
...
func (v *voidInvoiceEvent) validate() error {
    var errs []string
    if v.Id == nil {
