...
func (c *ChangeInvoiceCollectionMethodEvent) UnmarshalJSON(input []byte) error {
    var temp changeInvoiceCollectionMethodEvent
...
// changeInvoiceCollectionMethodEvent is a temporary struct used for validating the fields of ChangeInvoiceCollectionMethodEvent.
type changeInvoiceCollectionMethodEvent  struct {
    Id        *int64                                  `json:"id"`
...
func (c *changeInvoiceCollectionMethodEvent) validate() error {
    var errs []string
    if c.Id == nil {
