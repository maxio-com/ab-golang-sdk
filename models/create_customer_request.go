...
// String implements the fmt.Stringer interface for CreateCustomerRequest,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (c CreateCustomerRequest) String() string {
    return fmt.Sprintf(
    	"CreateCustomerRequest[Customer=%v, AdditionalProperties=%v]",
