...
// String implements the fmt.Stringer interface for PrepaidConfigurationResponse,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (p PrepaidConfigurationResponse) String() string {
    return fmt.Sprintf(
    	"PrepaidConfigurationResponse[PrepaidConfiguration=%v, AdditionalProperties=%v]",
    	p.PrepaidConfiguration, p.AdditionalProperties)
}
