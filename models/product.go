...
type Product struct {
	...
	ExpirationIntervalUnit Optional[ExtendedIntervalUnitEnum] `json:"expiration_interval_unit"`
	...
	IntervalUnit *IntervalUnitEnum `json:"interval_unit,omitempty"`
	...
	// A string representing the trial interval unit for this product, either month or day
	TrialIntervalUnit Optional[IntervalUnitEnum] `json:"trial_interval_unit"`
