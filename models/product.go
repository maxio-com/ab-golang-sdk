...
type Product struct {
	...
	ExpirationIntervalUnit Optional[ProductExpirationIntervalUnit] `json:"expiration_interval_unit"`
	...
	TrialIntervalUnit Optional[ProductTrialIntervalUnit] `json:"trial_interval_unit"`
...
func (p *Product) toMap() map[string]any {
	...
	if p.ExpirationIntervalUnit.IsValueSet() {
		if p.ExpirationIntervalUnit.Value() != nil {
			structMap["expiration_interval_unit"] = p.ExpirationIntervalUnit.Value().toMap()
		} else {
	...
	if p.TrialIntervalUnit.IsValueSet() {
		if p.TrialIntervalUnit.Value() != nil {
			structMap["trial_interval_unit"] = p.TrialIntervalUnit.Value().toMap()
		} else {
