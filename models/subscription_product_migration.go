...
func (s SubscriptionProductMigration) MarshalJSON() (
    ...
    if err := DetectConflictingProperties(s.AdditionalProperties,
        "product_id", "product_price_point_id", "include_trial", "include_initial_charge", "include_coupons", "preserve_period", "product_handle", "product_price_point_handle", "proration"); err != nil {
        return []byte{}, err
    }
...
func (s *SubscriptionProductMigration) UnmarshalJSON(input []byte) error {
    var temp tempSubscriptionProductMigration
    err := json.Unmarshal(input, &temp)
    if err != nil {
    	return err
    }
    additionalProperties, err := ExtractAdditionalProperties[interface{}](input, "product_id", "product_price_point_id", "include_trial", "include_initial_charge", "include_coupons", "preserve_period", "product_handle", "product_price_point_handle", "proration")
    if err != nil {
    	return err
    }
...
// tempSubscriptionProductMigration is a temporary struct used for validating the fields of SubscriptionProductMigration.
type tempSubscriptionProductMigration  struct {
    ProductId               *int       `json:"product_id,omitempty"`
    ProductPricePointId     *int       `json:"product_price_point_id,omitempty"`
    IncludeTrial            *bool      `json:"include_trial,omitempty"`
    IncludeInitialCharge    *bool      `json:"include_initial_charge,omitempty"`
