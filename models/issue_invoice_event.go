...
// issueInvoiceEvent is a temporary struct used for validating the fields of IssueInvoiceEvent.
type issueInvoiceEvent  struct {
    Id        *int64                 `json:"id"`
...
func (i *issueInvoiceEvent) validate() error {
    var errs []string
    if i.Id == nil {
