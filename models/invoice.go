...
func (i *Invoice) toMap() map[string]any {
	...
	if i.DueDate != nil {
		structMap["due_date"] = i.DueDate
	}
	if i.PaidDate.IsValueSet() {
		structMap["paid_date"] = i.PaidDate.Value()
	}
	if i.Status != nil {
	...
	if i.Seller != nil {
		structMap["seller"] = i.Seller
	}
	if i.Customer != nil {
		structMap["customer"] = i.Customer
	}
	if i.Payer != nil {
		structMap["payer"] = i.Payer
	}
	...
	if i.BillingAddress != nil {
		structMap["billing_address"] = i.BillingAddress
	}
	if i.ShippingAddress != nil {
		structMap["shipping_address"] = i.ShippingAddress
	}
	...
	if i.DisplaySettings != nil {
		structMap["display_settings"] = i.DisplaySettings
	}
	if i.PublicUrl != nil {
		structMap["public_url"] = i.PublicUrl
	}
	if i.PreviousBalanceData != nil {
		structMap["previous_balance_data"] = i.PreviousBalanceData
	}
	return structMap
}
