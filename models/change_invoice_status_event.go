...
// String implements the fmt.Stringer interface for ChangeInvoiceStatusEvent,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (c ChangeInvoiceStatusEvent) String() string {
    return fmt.Sprintf(
    	"ChangeInvoiceStatusEvent[Id=%v, Timestamp=%v, Invoice=%v, EventType=%v, EventData=%v, AdditionalProperties=%v]",
