...
func (a *AccountBalances) toMap() map[string]any {
	...
	if a.OpenInvoices != nil {
		structMap["open_invoices"] = a.OpenInvoices
	}
	if a.PendingDiscounts != nil {
		structMap["pending_discounts"] = a.PendingDiscounts
	}
	if a.ServiceCredits != nil {
		structMap["service_credits"] = a.ServiceCredits
	}
	if a.Prepayments != nil {
		structMap["prepayments"] = a.Prepayments
	}
	return structMap
}
