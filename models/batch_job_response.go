...
// String implements the fmt.Stringer interface for BatchJobResponse,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (b BatchJobResponse) String() string {
    return fmt.Sprintf(
    	"BatchJobResponse[Batchjob=%v, AdditionalProperties=%v]",
    	b.Batchjob, b.AdditionalProperties)
}
