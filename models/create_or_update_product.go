...
func (c *CreateOrUpdateProduct) UnmarshalJSON(input []byte) error {
    var temp createOrUpdateProduct
...
// createOrUpdateProduct is a temporary struct used for validating the fields of CreateOrUpdateProduct.
type createOrUpdateProduct  struct {
    Name                   *string       `json:"name"`
    Handle                 *string       `json:"handle,omitempty"`
    Description            *string       `json:"description"`
...
func (c *createOrUpdateProduct) validate() error {
    var errs []string
    if c.Name == nil {
