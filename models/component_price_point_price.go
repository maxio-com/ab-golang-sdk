...
// ComponentPricePointPrice represents a ComponentPricePointPrice struct.
type ComponentPricePointPrice struct {
...
// MarshalJSON implements the json.Marshaler interface for ComponentPricePointPrice.
// It customizes the JSON marshaling process for ComponentPricePointPrice objects.
func (c *ComponentPricePointPrice) MarshalJSON() (
	[]byte,
	error) {
	return json.Marshal(c.toMap())
}

// toMap converts the ComponentPricePointPrice object to a map representation for JSON marshaling.
func (c *ComponentPricePointPrice) toMap() map[string]any {
...
// UnmarshalJSON implements the json.Unmarshaler interface for ComponentPricePointPrice.
// It customizes the JSON unmarshaling process for ComponentPricePointPrice objects.
func (c *ComponentPricePointPrice) UnmarshalJSON(input []byte) error {
	temp := &struct {
		Id                 *int          `json:"id,omitempty"`
		ComponentId        *int          `json:"component_id,omitempty"`
		StartingQuantity   *int          `json:"starting_quantity,omitempty"`
