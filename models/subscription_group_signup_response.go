...
func (s *SubscriptionGroupSignupResponse) UnmarshalJSON(input []byte) error {
    var temp tempSubscriptionGroupSignupResponse
...
// tempSubscriptionGroupSignupResponse is a temporary struct used for validating the fields of SubscriptionGroupSignupResponse.
type tempSubscriptionGroupSignupResponse  struct {
    Uid                     *string                 `json:"uid,omitempty"`
    Scheme                  *int                    `json:"scheme,omitempty"`
    CustomerId              *int                    `json:"customer_id,omitempty"`
    PaymentProfileId        *int                    `json:"payment_profile_id,omitempty"`
