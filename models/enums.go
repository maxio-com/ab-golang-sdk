...
// PaymentCollectionMethod is a string enum.
// The type of payment collection to be used in the subscription. For legacy Statements Architecture valid options are - `invoice`, `automatic`. For current Relationship Invoicing Architecture valid options are - `remittance`, `automatic`, `prepaid`.
type PaymentCollectionMethod string

const (
    PaymentCollectionMethod_AUTOMATIC  PaymentCollectionMethod = "automatic"
    PaymentCollectionMethod_REMITTANCE PaymentCollectionMethod = "remittance"
    PaymentCollectionMethod_PREPAID    PaymentCollectionMethod = "prepaid"
    PaymentCollectionMethod_INVOICE    PaymentCollectionMethod = "invoice"
)
...
// ComponentKindPath is a string enum.
type ComponentKindPath string

const (
    ComponentKindPath_METEREDCOMPONENTS       ComponentKindPath = "metered_components"
    ComponentKindPath_QUANTITYBASEDCOMPONENTS ComponentKindPath = "quantity_based_components"
    ComponentKindPath_ONOFFCOMPONENTS         ComponentKindPath = "on_off_components"
    ComponentKindPath_PREPAIDUSAGECOMPONENTS  ComponentKindPath = "prepaid_usage_components"
    ComponentKindPath_EVENTBASEDCOMPONENTS    ComponentKindPath = "event_based_components"
)
...
// PaymentCollectionMethod1 is a string enum.
// (Optional) If not passed, the allocation(s) will use the payment collection method on the subscription
type PaymentCollectionMethod1 string

const (
    PaymentCollectionMethod1_AUTOMATIC  PaymentCollectionMethod1 = "automatic"
    PaymentCollectionMethod1_REMITTANCE PaymentCollectionMethod1 = "remittance"
    PaymentCollectionMethod1_PREPAID    PaymentCollectionMethod1 = "prepaid"
    PaymentCollectionMethod1_INVOICE    PaymentCollectionMethod1 = "invoice"
)
