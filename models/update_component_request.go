...
// String implements the fmt.Stringer interface for UpdateComponentRequest,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (u UpdateComponentRequest) String() string {
    return fmt.Sprintf(
    	"UpdateComponentRequest[Component=%v, AdditionalProperties=%v]",
    	u.Component, u.AdditionalProperties)
}
