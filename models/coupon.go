...
type Coupon struct {
	...
	RecurringScheme             *RecurringSchemeEnum `json:"recurring_scheme,omitempty"`
...
func (c *Coupon) toMap() map[string]any {
	...
	if c.DurationIntervalSpan != nil {
		structMap["duration_interval_span"] = c.DurationIntervalSpan
	}
