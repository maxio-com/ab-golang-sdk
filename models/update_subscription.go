...
func (u UpdateSubscription) MarshalJSON() (
    ...
    if err := DetectConflictingProperties(u.AdditionalProperties,
        "credit_card_attributes", "product_handle", "product_id", "product_change_delayed", "next_product_id", "next_product_price_point_id", "snap_day", "initial_billing_at", "defer_signup", "next_billing_at", "branding_theme_id", "expires_at", "payment_collection_method", "receives_invoice_emails", "net_terms", "stored_credential_transaction_id", "reference", "custom_price", "components", "dunning_communication_delay_enabled", "dunning_communication_delay_time_zone", "product_price_point_id", "product_price_point_handle"); err != nil {
        return []byte{}, err
    }
...
func (u *UpdateSubscription) UnmarshalJSON(input []byte) error {
    ...
    additionalProperties, err := ExtractAdditionalProperties[interface{}](input, "credit_card_attributes", "product_handle", "product_id", "product_change_delayed", "next_product_id", "next_product_price_point_id", "snap_day", "initial_billing_at", "defer_signup", "next_billing_at", "branding_theme_id", "expires_at", "payment_collection_method", "receives_invoice_emails", "net_terms", "stored_credential_transaction_id", "reference", "custom_price", "components", "dunning_communication_delay_enabled", "dunning_communication_delay_time_zone", "product_price_point_id", "product_price_point_handle")
    if err != nil {
    	return err
    }
