...
func (s *Site) toMap() map[string]any {
	...
	if s.AllocationSettings != nil {
		structMap["allocation_settings"] = s.AllocationSettings
	}
	...
	if s.OrganizationAddress != nil {
		structMap["organization_address"] = s.OrganizationAddress
	}
	if s.TaxConfiguration != nil {
		structMap["tax_configuration"] = s.TaxConfiguration
	}
	if s.NetTerms != nil {
		structMap["net_terms"] = s.NetTerms
	}
	if s.Test != nil {
