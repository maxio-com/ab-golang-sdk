...
func (f *FullSubscriptionGroupResponse) UnmarshalJSON(input []byte) error {
    var temp tempFullSubscriptionGroupResponse
...
// tempFullSubscriptionGroupResponse is a temporary struct used for validating the fields of FullSubscriptionGroupResponse.
type tempFullSubscriptionGroupResponse  struct {
    Uid                         *string                    `json:"uid,omitempty"`
    Scheme                      *int                       `json:"scheme,omitempty"`
    CustomerId                  *int                       `json:"customer_id,omitempty"`
    PaymentProfileId            *int                       `json:"payment_profile_id,omitempty"`
