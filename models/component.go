...
type Component struct {
	...
	PricingScheme Optional[PricingSchemeEnum] `json:"pricing_scheme"`
	...
	Kind *ComponentKindEnum `json:"kind,omitempty"`
...
func (c *Component) toMap() map[string]any {
	...
	if c.PricingScheme.IsValueSet() {
		structMap["pricing_scheme"] = c.PricingScheme.Value()
	}
	if c.UnitName != nil {
	...
	if c.DefaultPricePointId != nil {
		structMap["default_price_point_id"] = c.DefaultPricePointId
	}
