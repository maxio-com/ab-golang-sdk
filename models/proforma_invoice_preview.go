...
// MarshalJSON implements the json.Marshaler interface for ProformaInvoicePreview.
// It customizes the JSON marshaling process for ProformaInvoicePreview objects.
...
// toMap converts the ProformaInvoicePreview object to a map representation for JSON marshaling.
func (p *ProformaInvoicePreview) toMap() map[string]any {
...
// UnmarshalJSON implements the json.Unmarshaler interface for ProformaInvoicePreview.
// It customizes the JSON unmarshaling process for ProformaInvoicePreview objects.
