...
// ReadMrrMovements takes context, subscriptionId, page, perPage, direction as parameters and
// returns an models.ApiResponse with models.ListMRRResponse data and
// an error if there was an issue with the request or response.
// Deprecated: readMrrMovements is deprecated
...
func (i *InsightsController) ReadMrrMovements(
    ctx context.Context,
    subscriptionId *int,
    page *int,
    perPage *int,
