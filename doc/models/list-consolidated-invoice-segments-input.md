...
| `Direction` | [`*models.Direction`](../../doc/models/direction.md) | Optional | Sort direction of the returned segments.<br><br>**Default**: `"asc"` |
...
func main() {
    listConsolidatedInvoiceSegmentsInput := models.ListConsolidatedInvoiceSegmentsInput{
