...
| `Customer` | [`*models.InvoiceCustomer`](../../doc/models/invoice-customer.md) | Optional | Information about the customer who is the owner or recipient of the debited subscription. |
...
func main() {
    debitNote := models.DebitNote{
        ...
        SiteId:                 models.ToPointer(196),
        CustomerId:             models.ToPointer(52),
        SubscriptionId:         models.ToPointer(124),
        Number:                 models.ToPointer(0),
    }
