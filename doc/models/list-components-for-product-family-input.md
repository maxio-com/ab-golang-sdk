...
| `DateField` | [`*models.BasicDateField`](../../doc/models/basic-date-field.md) | Optional | The type of filter you would like to apply to your search. Use in query `date_field=created_at`. |
...
func main() {
    listComponentsForProductFamilyInput := models.ListComponentsForProductFamilyInput{
        ProductFamilyId:      140,
