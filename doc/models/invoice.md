...
| `Customer` | [`*models.InvoiceCustomer`](../../doc/models/invoice-customer.md) | Optional | Information about the customer who is owner or recipient of the invoiced subscription. |
...
| `Debits` | [`[]models.InvoiceDebit`](../../doc/models/invoice-debit.md) | Optional | - |
...
| `AvataxDetails` | [`*models.InvoiceAvataxDetails`](../../doc/models/invoice-avatax-details.md) | Optional | - |
...
| `BrandingThemeId` | `models.Optional[int]` | Optional | The ID of the Branding Theme associated with this invoice. This value represents the Branding Theme used for invoice theming, such as themed invoice rendering. Available only when Branding Themes are enabled for the site. |
