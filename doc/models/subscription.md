...
| `CancellationMethod` | [`Optional[models.CancellationMethodEnum]`](cancellation-method-enum.md) | Optional | The process used to cancel the subscription, if the subscription has been canceled. It is nil if the subscription's state is not canceled. |
...
| `PreviousState` | [`*models.SubscriptionStateEnum`](subscription-state-enum.md) | Optional | Only valid for webhook payloads The previous state for webhooks that have indicated a change in state. For normal API calls, this will always be the same as the state (current state) |
...
| `Customer` | [`*models.Customer`](customer.md) | Optional | - |
| `Product` | [`*models.Product`](product.md) | Optional | - |
| `CreditCard` | [`*models.PaymentProfile`](payment-profile.md) | Optional | - |
| `Group` | [`Optional[models.NestedSubscriptionGroup]`](nested-subscription-group.md) | Optional | - |
| `BankAccount` | [`*models.SubscriptionBankAccount`](subscription-bank-account.md) | Optional | - |
...
| `Coupons` | [`[]models.SubscriptionIncludedCoupon`](subscription-included-coupon.md) | Optional | Additional coupon data. To use this data you also have to include the following param in the request`include[]=coupons`.<br>Only in Read Subscription Endpoint. |
...
| `PrepaidConfiguration` | [`*models.PrepaidConfiguration`](prepaid-configuration.md) | Optional | - |
