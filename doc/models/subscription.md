...
| `CurrentPeriodEndsAt` | `models.Optional[time.Time]` | Optional | Timestamp relating to the end of the current (recurring) period (i.e., when the next regularly scheduled attempted charge will occur) |
...
| `SnapDay` | `models.Optional[string]` | Optional | A day of month that subscription will be processed on. Can be 1 up to 28 or 'end'. |
...
| `ReasonCode` | `models.Optional[string]` | Optional | The churn reason code associated to a canceled subscription. |
...
| `Reference` | `models.Optional[string]` | Optional | The reference value (provided by your app) for the subscription itself. |
...
func main() {
    subscription := models.Subscription{
        ...
        CreditCard:                        models.ToPointer(models.CreditCardPaymentProfile{
