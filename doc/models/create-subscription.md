...
| `CustomerAttributes` | [`*models.CustomerAttributes`](customer-attributes.md) | Optional | - |
| `PaymentProfileAttributes` | [`*models.PaymentProfileAttributes`](payment-profile-attributes.md) | Optional | alias to credit_card_attributes |
| `CreditCardAttributes` | [`*models.PaymentProfileAttributes`](payment-profile-attributes.md) | Optional | Credit Card data to create a new Subscription. Interchangeable with `payment_profile_attributes` property. |
| `BankAccountAttributes` | [`*models.BankAccountAttributes`](bank-account-attributes.md) | Optional | - |
| `Components` | [`[]models.CreateSubscriptionComponent`](create-subscription-component.md) | Optional | (Optional) An array of component ids and quantities to be added to the subscription. See [Components](https://maxio-chargify.zendesk.com/hc/en-us/articles/5405020625677) for more information. |
...
| `Group` | [`*models.GroupSettings`](group-settings.md) | Optional | - |
...
| `PrepaidConfiguration` | [`*models.UpsertPrepaidConfiguration`](upsert-prepaid-configuration.md) | Optional | - |
...
| `AgreementAcceptance` | [`*models.AgreementAcceptance`](agreement-acceptance.md) | Optional | Required when creating a subscription with Maxio Payments. |
| `AchAgreement` | [`*models.ACHAgreement`](ach-agreement.md) | Optional | (Optional) If passed, the proof of the authorized ACH agreement terms will be persisted. |
