...
| `CustomPrice` | [`*models.SubscriptionCustomPrice`](../../doc/models/subscription-custom-price.md) | Optional | (Optional) Used in place of `product_price_point_id` to define a custom price point unique to the subscription. A subscription can have up to 30 custom price points. Exceeding this limit will result in an API error. |
...
func main() {
    subscriptionGroupSignupItem := models.SubscriptionGroupSignupItem{
        ProductHandle:           models.ToPointer("product_handle8"),
        ProductId:               models.ToPointer(12),
        ProductPricePointId:     models.ToPointer(192),
        ProductPricePointHandle: models.ToPointer("product_price_point_handle8"),
        OfferId:                 models.ToPointer(172),
