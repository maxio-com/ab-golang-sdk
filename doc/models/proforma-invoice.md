...
| `AvailableActions` | [`*models.AvailableActions`](../../doc/models/available-actions.md) | Optional | - |
...
func main() {
    proformaInvoice := models.ProformaInvoice{
        ...
        SiteId:               models.ToPointer(94),
        CustomerId:           models.NewOptional(models.ToPointer(206)),
        SubscriptionId:       models.NewOptional(models.ToPointer(22)),
        Number:               models.NewOptional(models.ToPointer(102)),
    }
