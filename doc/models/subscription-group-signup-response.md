...
func main() {
    subscriptionGroupSignupResponse := models.SubscriptionGroupSignupResponse{
        Uid:                     models.ToPointer("uid4"),
        Scheme:                  models.ToPointer(60),
        CustomerId:              models.ToPointer(80),
        PaymentProfileId:        models.ToPointer(244),
        SubscriptionIds:         []int{
            190,
        },
    }
