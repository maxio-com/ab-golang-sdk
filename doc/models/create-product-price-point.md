...
func main() {
    createProductPricePoint := models.CreateProductPricePoint{
        Name:                    "name6",
        Handle:                  models.ToPointer("handle2"),
        PriceInCents:            int64(180),
        Interval:                60,
        IntervalUnit:            models.IntervalUnit_DAY,
        TrialPriceInCents:       models.ToPointer(int64(92)),
        TrialInterval:           models.ToPointer(218),
