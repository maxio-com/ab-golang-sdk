...
| `Customer` | [`*models.InvoiceCustomer`](../../doc/models/invoice-customer.md) | Optional | Information about the customer who is owner or recipient of the credited subscription. |
...
| `OriginInvoices` | [`[]models.OriginInvoice`](../../doc/models/origin-invoice.md) | Optional | An array of origin invoices for the credit note. Learn more about [Origin Invoice from our docs](https://maxio.zendesk.com/hc/en-us/articles/24252261284749-Credit-Notes-Proration#origin-invoices). |
...
func main() {
    creditNote := models.CreditNote{
        ...
        SiteId:               models.ToPointer(20),
        CustomerId:           models.ToPointer(132),
        SubscriptionId:       models.ToPointer(204),
